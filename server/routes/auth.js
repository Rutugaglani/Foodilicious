...
router.get('/order/:user_id/:restaurant_id/:loc_id', dataController.getCurrentOrder);
router.get('/getPresentInAn/:order_id', dataController.getPresentInAn);
router.get('/order/:user_id', authController.getUserOrders);
